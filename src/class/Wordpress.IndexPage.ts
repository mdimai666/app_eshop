...
import { Wordpress as W2 } from './Wordpress.Page'
import { Wordpress as W3 } from './Wordpress.Index.Acf'
import { Wordpress as ImplW3 } from './Wordpress.Index.Acf.Impl'

export namespace Wordpress {
    export class IndexPage extends W2.Page {
        public id: number = -1
        ...
        public acf: W3.Acf_Index = new ImplW3.ImplAcf_Index
        ...
        constructor(page: Partial<IndexPage>) {
            super(page)
